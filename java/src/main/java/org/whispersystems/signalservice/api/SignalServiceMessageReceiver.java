...
public class SignalServiceMessageReceiver {
  ...
  {
    this(urls, new StaticCredentialsProvider(user, password, signalingKey, deviceId), userAgent, listener);
  }
  ...
  public SignalServiceMessageReceiver(SignalServiceConfiguration urls,
                                      ...
                                      ConnectivityListener listener)
  {
    this(urls, new StaticCredentialsProvider(user, password, signalingKey, SignalServiceAddress.DEFAULT_DEVICE_ID), userAgent, listener);
  }
