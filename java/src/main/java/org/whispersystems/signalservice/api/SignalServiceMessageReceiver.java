...
public class SignalServiceMessageReceiver {
  ...
  public SignalServiceMessageReceiver(SignalServiceConfiguration urls,
                                      ...
                                      SleepTimer timer)
  {
    this(urls, new StaticCredentialsProvider(user, password, signalingKey, deviceId), userAgent, listener, timer);
  }
  ...
  public SignalServiceMessageReceiver(SignalServiceConfiguration urls,
                                      ...
                                      SleepTimer timer)
  {
    this(urls, new StaticCredentialsProvider(user, password, signalingKey, SignalServiceAddress.DEFAULT_DEVICE_ID), userAgent, listener, timer);
  }
