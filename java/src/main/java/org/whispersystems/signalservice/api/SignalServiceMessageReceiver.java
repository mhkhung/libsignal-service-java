...
public class SignalServiceMessageReceiver {
  ...
  {
    this(urls, new StaticCredentialsProvider(user, password, signalingKey, deviceId), userAgent);
  }
  ...
  public SignalServiceMessageReceiver(SignalServiceUrl[] urls,
                                      ...
                                      String signalingKey, String userAgent)
  {
    this(urls, new StaticCredentialsProvider(user, password, signalingKey, SignalServiceAddress.DEFAULT_DEVICE_ID), userAgent);
  }
