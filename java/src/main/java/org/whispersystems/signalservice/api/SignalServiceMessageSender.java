...
public class SignalServiceMessageSender {
  ...
  public SignalServiceMessageSender(SignalServiceConfiguration urls,
                                    ...
                                    Optional<EventListener> eventListener)
  {
    this(urls, new StaticCredentialsProvider(uuid, e164, password, null, SignalServiceAddress.DEFAULT_DEVICE_ID), store, userAgent, isMultiDevice, pipe, unidentifiedPipe, eventListener);
  }
